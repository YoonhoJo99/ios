...
//    let list: [AppleFramework] = AppleFramework.list
    ...
    override func viewDidLoad() {
        ...
        // CollectionView Presentation, Layout 설정해 주는 것
        // CollectionView Data 설정해 주는 것
        configureCollectionView()
        bind()
        
    }
    private func bind(){ // 이 ViewController의 핵심 로직, Combine을 이용해서 로직을 한꺼번에 처리한다. 그래야 보기 좋음
